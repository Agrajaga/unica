...
Legacy migration is frozen in the immutable `v0.7.7` release, where one native
...
engine or acquisition shims; old installations first cross the `v0.7.7` bridge
