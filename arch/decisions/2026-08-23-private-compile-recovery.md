...
публикуемой цели и recovery до завершения rollback. До первой публикации она
проверяет, что эти parent находятся на одной файловой системе; несовместимый
workspace layout отклоняется без изменения целей.
